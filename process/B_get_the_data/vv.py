...
import process.B_get_the_data.pp as pp  # importing
...
LISTING_ENRICHED_FILE = "../../data/working/listings_data_enriched.csv"
LISTING_BASIC_FILE = "../../data/working/listings_data_basic.csv"
LISTING_AGE_FILE = "../../data/working/listings_data_age.csv"
LISTING_AGE_FILE1 = "../../data/working/listings_data_age1.csv"

LISTING_JSON_MODEL_FILE = "../../data/working/listings_data_jsonmodel.csv"
LISTING_JSON_MODEL_TRIAL = "../../data/working/listings_data_jsonmodel_trial.csv"
LISTING_JSON_MODEL_FAILED = "../../data/working/listings_data_jsonmodel_failed.csv"

LISTING_JSON_MODEL_BID_FILE = "../../data/working/listings_data_jsonmodel__bids_only.csv"
LISTING_JSON_MODEL_BID_TRIAL = "../../data/working/listings_data_jsonmodel__bids_only_trial.csv"
LISTING_JSON_MODEL_BID_FAILED = "../../data/working/listings_data_jsonmodel__bids_only_failed.csv"

LISTING_JSON_META_FILE = "../../data/working/listings_data_jsonmeta.csv"

LISTING_ENRICHED_STABLE = "../../data/working/check1/listings_data_enriched.csv"
LISTING_BASIC_STABLE = "../../data/working/check1/listings_data_basic.csv"
LISTING_JSON_MODEL_STABLE = "../../data/working/check1/listings_data_jsonmodel.csv"
LISTING_JSON_MODEL_BID_STABLE = "../../data/working/check1/listings_data_jsonmodel__bids_only.csv"
LISTING_JSON_META_STABLE = "../../data/working/check1/listings_data_jsonmeta.csv"
...
LISTING_COMBINED_FILE = "../../data/working/listings_data_combined.csv"
QUICK_COMBINED_FILE = "../../data/working/listings_data_quick.csv"

AUDIT_FILE = "../../data/working/ww_audit.json"
WORDCLOUD_FILE = "../../data/working/ww_worldcloud.json"
REMOVED_FILE = "../../data/working/ww_removed.csv"
CORRUPT_FILE = "../../data/working/ww_corrupt.csv"
...
def tidy_dataset(property_dataset, coerce_to_int=None, coerce_to_float=None, na_infer_median=None, na_drop_column=None, na_drop_rows=None):
    ...
    property_dataset['Price'] = pd.to_numeric(property_dataset['Price'], 'coerce').dropna().astype(float)
    ...
    property_dataset = property_dataset[(property_dataset['analyticsProperty.maxSizeFt'] <= 2000) | (np.isnan(property_dataset['analyticsProperty.maxSizeFt'])) ]
...
def get_combined_dataset_OLD(HOW, early_duplicates, row_limit=None,verbose=False):
    ...
    df_json1 = pd.read_csv(LISTING_JSON_MODEL_FILE, on_bad_lines='warn')  # EDIT 29-06-2022: There are bid listings and regular listings. I scrape them seporately and join them here.
